  ...
  return (
    ...
    >
      <div className="container mx-auto flex justify-between items-center">
        <div
          className="h-9 cursor-pointer font-sora font-extrabold text-2xl flex items-center"
          onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
        >
          Saumya<span className="text-gray-400">.</span>
        </div>

        <ul className="hidden lg:flex items-center gap-x-7 font-bold text-sm tracking-wide">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="lg:hidden fixed top-0 left-0 h-screen w-full bg-white z-40 flex flex-col items-center justify-center gap-8"
          >
