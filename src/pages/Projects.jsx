              ...
              <Tilt options={defaultOptions}>
                ...
                >
                  ...
                  <div className="p-8 flex flex-col flex-grow relative z-10">
                    ...
                    <h3 className="text-2xl font-extrabold mb-3 text-white tracking-tight drop-shadow-md group-hover:text-cyan-200 transition-colors">{project.title}</h3>
                    <p className="text-gray-300 text-sm mb-6 line-clamp-3 text-ellipsis leading-relaxed font-medium">{project.desc}</p>
                    ...
                    <a href={project.link} target="_blank" rel="noreferrer" className="mt-8 block text-center font-bold border border-white/30 bg-white/10 py-3 rounded-lg hover:bg-white hover:text-black transition-all text-white tracking-wide uppercase text-sm shadow-inner hover:shadow-lg backdrop-blur-md">
                      View Project
                    </a>
                  </div>
                </div>
