...
const ProjectCard = ({ project, index }) => {
  return (
    ...
    >
      ...
      >
        {/* Image Container */}
        <div className="relative w-full h-48 rounded-xl overflow-hidden mb-5 bg-white/5">
          <img 
            src={project.img} 
            alt={project.title} 
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-space font-bold text-white">
            Featured <span className="text-hive-cyan border-b-4 border-hive-cyan pb-1">Projects</span>
          </h2>
