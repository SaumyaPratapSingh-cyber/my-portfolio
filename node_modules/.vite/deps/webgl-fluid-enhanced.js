...
// node_modules/webgl-fluid-enhanced/dist/index.es.js
var R = Object.defineProperty;
var y = (d, t, e) => t in d ? R(d, t, { enumerable: true, configurable: true, writable: true, value: e }) : d[t] = e;
...
var v = class _v {
  static generateColor(t, e) {
    ...
    if (!(t.length > 0))
      ...
      const a = Math.floor(Math.random() * t.length), h = t[a], n = _v.HEXtoHSV(h);
      i = n.h, r = n.s;
    }
    const o = _v.HSVtoRGB(i, r, e);
...
var x = class {
  ...
  updatePointerDownData(t, e, i, r, o, a) {
    this.id = t, this.down = true, this.moved = false, this.texcoordX = e / r.width, this.texcoordY = 1 - i / r.height, this.prevTexcoordX = this.texcoordX, this.prevTexcoordY = this.texcoordY, this.deltaX = 0, this.deltaY = 0, this.color = v.generateColor(o, a);
  }
...
var g = class _g {
  static normalizeTexture(t, e, i) {
    ...
    for (let a = i - 1; a >= 0; a--)
      for (let h = 0; h < e; h++) {
        const n = a * e * 4 + h * 4;
        r[n + 0] = _g.clamp01(t[o + 0]) * 255, r[n + 1] = _g.clamp01(t[o + 1]) * 255, r[n + 2] = _g.clamp01(t[o + 2]) * 255, r[n + 3] = _g.clamp01(t[o + 3]) * 255, o += 4;
      }
    return r;
  }
  static clamp01(t) {
...
var D = class {
  constructor(t) {
    ...
    s(this, "paused", false);
    s(this, "drawWhilePaused", false);
    s(this, "_inverted", false);
    s(this, "canvas");
    s(this, "gl");
    s(this, "ext");
    s(this, "splatStack", []);
    ...
    s(this, "handleMouseDown", (t2) => {
      const e2 = this.scaleByPixelRatio(t2.offsetX), i2 = this.scaleByPixelRatio(t2.offsetY);
      let r2 = this.pointers.find((o2) => o2.id == -1);
      r2 || (r2 = new x(this.colorPalette, this.brightness)), r2.updatePointerDownData(
        -1,
        e2,
        i2,
        this.canvas,
    ...
    s(this, "handleMouseMove", (t2) => {
      const e2 = this.scaleByPixelRatio(t2.offsetX), i2 = this.scaleByPixelRatio(t2.offsetY);
      let r2 = this.pointers.find((o2) => o2.id == -1);
      r2 || (r2 = new x(this.colorPalette, this.brightness)), r2.updatePointerMoveData(e2, i2, this.canvas, this.hover);
    });
    s(this, "handleMouseUp", () => {
      this.hover || this.pointers[0].updatePointerUpData();
    });
    s(this, "handleTouchStart", (t2) => {
      const e2 = t2.targetTouches;
      for (; e2.length >= this.pointers.length; )
        this.pointers.push(new x(this.colorPalette, this.brightness));
      for (let i2 = 0; i2 < e2.length; i2++) {
        const r2 = this.scaleByPixelRatio(e2[i2].pageX), o2 = this.scaleByPixelRatio(e2[i2].pageY);
        this.pointers[i2 + 1].updatePointerDownData(
          e2[i2].identifier,
          r2,
          o2,
          this.canvas,
    ...
    s(this, "handleTouchMove", (t2) => {
      const e2 = t2.targetTouches;
      for (let i2 = 0; i2 < e2.length; i2++) {
        const r2 = this.pointers[i2 + 1], o2 = this.scaleByPixelRatio(e2[i2].pageX), a = this.scaleByPixelRatio(e2[i2].pageY);
        r2.updatePointerMoveData(o2, a, this.canvas, this.hover);
      }
    });
    s(this, "handleTouchEnd", (t2) => {
      const e2 = t2.changedTouches;
      for (const i2 of e2) {
        const r2 = this.pointers.find(
          (o2) => o2.id === i2.identifier
        );
        r2 && r2.updatePointerUpData();
      }
    });
    ...
    this.gl = i, this.ext = r, this.isMobile() && (this.dyeResolution /= 2), this.ext.supportLinearFiltering || (this.dyeResolution /= 2, this.shading = false, this.bloom = false, this.sunrays = false);
  ...
  resizeCanvas() {
    ...
    return this.canvas.width != t || this.canvas.height != e ? (this.canvas.width = t, this.canvas.height = e, true) : false;
  }
  ...
  blitInit() {
    this.gl.bindBuffer(this.gl.ARRAY_BUFFER, this.gl.createBuffer()), this.gl.bufferData(
      ...
      this.gl.STATIC_DRAW
    ), this.gl.vertexAttribPointer(0, 2, this.gl.FLOAT, false, 0, 0), this.gl.enableVertexAttribArray(0);
  }
  blit(t, e = false) {
  ...
  applyInputs() {
    this.splatStack.length > 0 && this.multipleSplats(this.splatStack.pop()), this.pointers.forEach((t) => {
      t.moved && (t.moved = false, this.splatPointer(t));
    });
  }
  splatPointer(t) {
    if (this.paused && !this.drawWhilePaused)
      return;
...
var U = class {
  ...
  togglePause(t = false) {
    return this.simulation.hasStarted ? (this.simulation.paused = !this.simulation.paused, this.simulation.paused && (this.simulation.drawWhilePaused = t), this.simulation.paused) : false;
  }
  multipleSplats(t) {
...
//# sourceMappingURL=webgl-fluid-enhanced.js.map
