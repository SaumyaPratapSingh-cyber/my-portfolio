  ...
  constructor() {
    this.raf = (a3) => {
      ...
      for (let s2 = 0; s2 < this.callbacks.length; s2++)
        this.callbacks[s2].callback(a3, t3);
...
function f(e3, n3 = 0) {
  (0, import_react.useEffect)(() => {
    if (e3)
      return a.add(e3, n3), () => a.remove(e3);
  }, [e3, n3]);
}
function g() {
...
function k({ ignoreTransform: r2 = false, ignoreSticky: c2 = true, debounce: u2 = 500, lazy: s2 = false, callback: a3 } = {}) {
  const [d2, l2] = (0, import_react.useState)(), f3 = (0, import_react.useRef)({}), [h, m2] = (0, import_react.useState)({}), v = (0, import_react.useCallback)(({ top: e3, left: t3, width: n3, height: r3, element: o3 }) => {
    var c3, i2, u3, d3, l3;
    e3 = null != (c3 = e3) ? c3 : f3.current.top, t3 = null != (i2 = t3) ? i2 : f3.current.left, n3 = null != (u3 = n3) ? u3 : f3.current.width, r3 = null != (d3 = r3) ? d3 : f3.current.height, o3 = null != (l3 = o3) ? l3 : f3.current.element, e3 === f3.current.top && t3 === f3.current.left && n3 === f3.current.width && r3 === f3.current.height && o3 === f3.current.element || (f3.current.top = e3, f3.current.y = e3, f3.current.width = n3, f3.current.height = r3, f3.current.left = t3, f3.current.x = t3, f3.current.bottom = e3 + r3, f3.current.right = t3 + n3, f3.current.element = o3, null == a3 || a3(f3.current), s2 || m2(g({}, f3.current)));
  }, [s2]);
  (0, import_react.useEffect)(() => {
    if (!d2)
      return;
...
var Animate = class {
  advance(e3) {
    ...
    let i2 = false;
    if (this.lerp)
      this.value = (s2 = this.value, o3 = this.to, n3 = 60 * this.lerp, r2 = e3, function(t3, e4, i3) {
...
var Dimensions = class {
  constructor({ wrapper: t3, content: e3, autoResize: i2 = true, debounce: s2 = 250 } = {}) {
    ...
    this.wrapper = t3, this.content = e3, i2 && (this.debouncedResize = function(t4, e4) {
      let i3;
      return function() {
...
var Emitter = class {
  ...
  emit(t3, ...e3) {
    ...
    for (let t4 = 0, s2 = i2.length; t4 < s2; t4++)
      i2[t4](...e3);
  }
  on(t3, e3) {
    var _a;
...
var Lenis = class {
  constructor({ wrapper: t3 = window, content: e3 = document.documentElement, wheelEventsTarget: i2 = t3, eventsTarget: s2 = i2, smoothWheel: o3 = true, syncTouch: n3 = false, syncTouchLerp: r2 = 0.075, touchInertiaMultiplier: l2 = 35, duration: h, easing: a3 = (t4) => Math.min(1, 1.001 - Math.pow(2, -10 * t4)), lerp: c2 = !h && 0.1, infinite: d2 = false, orientation: p2 = "vertical", gestureOrientation: u2 = "vertical", touchMultiplier: m2 = 1, wheelMultiplier: v = 1, autoResize: g2 = true, __experimental__naiveDimensions: S = false } = {}) {
    this.__isSmooth = false, this.__isScrolling = false, this.__isStopped = false, this.__isLocked = false, this.onVirtualScroll = ({ deltaX: t4, deltaY: e4, event: i3 }) => {
      ...
      if (this.options.syncTouch && s3 && "touchstart" === i3.type && !this.isStopped && !this.isLocked)
      ...
      if (this.isSmooth = this.options.syncTouch && s3 || this.options.smoothWheel && o4, !this.isSmooth)
  ...
  scrollTo(e3, { offset: i2 = 0, immediate: s2 = false, lock: o3 = false, duration: n3 = this.options.duration, easing: r2 = this.options.easing, lerp: l2 = !n3 && this.options.lerp, onComplete: h, force: a3 = false, programmatic: c2 = true } = {}) {
    if (!this.isStopped && !this.isLocked || a3) {
      if (["top", "left", "start"].includes(e3))
        e3 = 0;
      else if (["bottom", "right", "end"].includes(e3))
        e3 = this.limit;
      else {
        let t3;
      ...
      if ("number" == typeof e3) {
        if (e3 += i2, e3 = Math.round(e3), this.options.infinite ? c2 && (this.targetScroll = this.animatedScroll = this.scroll) : e3 = t2(0, e3, this.limit), s2)
          return this.animatedScroll = this.targetScroll = e3, this.setScroll(this.scroll), this.reset(), void (null == h || h(this));
        if (!c2) {
          if (e3 === this.targetScroll)
            return;
...
// node_modules/@studio-freight/react-lenis/node_modules/zustand/esm/vanilla.mjs
...
// node_modules/@studio-freight/react-lenis/node_modules/zustand/esm/index.mjs
...
function b2(r2, e3 = [], t3 = 0) {
  const { lenis: n3, addCallback: o3, removeCallback: a3 } = function() {
    const r3 = (0, import_react3.useContext)(d), e4 = m();
    return null != r3 ? r3 : e4;
  }();
  return (0, import_react3.useEffect)(() => {
    if (r2 && o3 && a3 && n3)
      return o3(r2, t3), r2(n3), () => {
        a3(r2);
      };
  }, [n3, o3, a3, t3, ...e3]), n3;
}
var y2 = (0, import_react3.forwardRef)((o3, a3) => {
  var { children: f3, root: p2 = false, options: b3 = {}, autoRaf: y3 = true, rafPriority: v = 0, className: O } = o3, g2 = function(r2, e3) {
    var t3 = {};
    for (var n3 in r2)
      Object.prototype.hasOwnProperty.call(r2, n3) && e3.indexOf(n3) < 0 && (t3[n3] = r2[n3]);
    if (null != r2 && "function" == typeof Object.getOwnPropertySymbols) {
      var o4 = 0;
      for (n3 = Object.getOwnPropertySymbols(r2); o4 < n3.length; o4++)
        e3.indexOf(n3[o4]) < 0 && Object.prototype.propertyIsEnumerable.call(r2, n3[o4]) && (t3[n3[o4]] = r2[n3[o4]]);
    }
    return t3;
  }(o3, ["children", "root", "options", "autoRaf", "rafPriority", "className"]);
  const h = (0, import_react3.useRef)(null), w = (0, import_react3.useRef)(null), [k2, N] = (0, import_react3.useState)(void 0), j = (0, import_react3.useRef)([]), C = (0, import_react3.useCallback)((r2, e3) => {
  ...
  (0, import_react3.useImperativeHandle)(a3, () => ({ wrapper: h.current, content: w.current, lenis: k2 }), [k2]), (0, import_react3.useEffect)(() => {
    const r2 = new Lenis(Object.assign(Object.assign({}, b3), !p2 && { wrapper: h.current, content: w.current }));
    return N(r2), () => {
      r2.destroy(), N(void 0);
    };
  }, [p2, JSON.stringify(b3)]), f((r2) => {
  ...
  const P2 = (0, import_react3.useCallback)((r2) => {
    for (let e3 = 0; e3 < j.current.length; e3++)
      j.current[e3].callback(r2);
  }, []);
